                        ...
                        <div class="pull-right">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-3">
                                <ul class=" navbar-right login-right-nav">
                                    ...
                                    <li>
                                        <a class="btn btn-info btn-fb" aria-label="Left Align" onclick="goLogin()">
                                            <span class="fa fa-facebook-f"></span> Login with Facebook</a>
                                    </li>
                                    <li>
                                        <a class="btn btn-info " aria-label="Left Align" onclick="loginWithGoogle()">
...
<div class="header-botom" @if(Auth::check()) style="display:block;" @endif>
