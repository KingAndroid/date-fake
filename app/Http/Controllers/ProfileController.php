...
class ProfileController extends Controller
{
    public function getIndex()
    {
        ...
        // dd($all_users);
        return View::make('profile')->with(array('data'=>$data,'username'=>$uname, 'currentUser'=>1, 'banners' => $banners));
    ...
    public function getUserMatch($username){
        ...
        $gender = $current_user[0]->gender?$current_user[0]->gender:'';
        $all_users = User::orderByRaw("RAND()")->where('gender', '!=', $gender)->get();
