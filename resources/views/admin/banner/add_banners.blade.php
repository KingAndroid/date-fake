                ...
                <!-- <div class="">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="file-upload">
                          <input type="file" name="uploadpicture" accept="image/*"  class="file-input ImgeInput" id="uploadpicture" required />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      ...
                      <textarea  class="form-control summernote" name="sub_title"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
