  ...
  <script src="{{ url() }}/public/plugins/angularjs/plugins/angular-route.min.js"></script>
  ...
  <script src="{{ url() }}/public/plugins/angularjs/modules/signup/controllers/signupController.js"></script>
